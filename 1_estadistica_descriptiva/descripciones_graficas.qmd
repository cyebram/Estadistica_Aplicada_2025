...
#municipios_jalisco <- st_read("1_estadistica_descriptiva/data/14mun.shp", options = "ENCODING=LATIN1", quiet = TRUE)
...
datos_total <- read_csv("data/cpv_valor_14.csv", na = c("ND"))
...
datos <- left_join(municipios_jalisco, datos)
```
...
ggplot(datos) +
  ...
  labs(
    title = "Edad (mediana) de los Municipios de Jalisco",
    caption = "Fuente: INEGI - Marco Geoestadístico"
  ) +
  theme_void() +
  theme(
...
ggplot(data = datos, aes(x = "", y = edad_mediana)) +
  ...
  subtitle = "Población del Estado de Jalisco",
  y = "Edad (años)",
  x = "")+
  theme_bw()+
  theme(
...
ggplot(data = datos, aes(sample = edad_mediana)) +
    ...
    subtitle = "Edad Mediana - Población Jalisco") +
    theme_bw()+
    theme(
    legend.title = element_text(size=13, face="bold"),
    legend.text = element_text(size=13),
...
ggplot(datos) +
  ...
  labs(
    title = "Derechohabientes IMSS (%) de los Municipios de Jalisco",
    caption = "Fuente: INEGI - Marco Geoestadístico"
  ) +
  theme_void() +
  theme(
...
ggplot(data = datos, aes(sample = porcentaje_de_la_poblacion_derechohabiente_en_el_imss)) +
    ...
    labs(title = "Gráfico Q-Q para Normalidad",
    subtitle = "Derechohabientes IMSS (%) - Jalisco") +
    theme_bw()+
    theme(
    legend.title = element_text(size=13, face="bold"),
    legend.text = element_text(size=13),
...
ggplot(datos) +
  ...
  labs(
    title = "Población de los Municipios de Jalisco",
    caption = "Fuente: INEGI - Marco Geoestadístico"
  ) +
  theme_void() +
  theme(
